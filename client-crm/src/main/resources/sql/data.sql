...
INSERT INTO ORDERS(ORDER_ID, AMOUNT, DESCRIPTION, CLIENT_ID) VALUES (1, 1000000, 'пару кубов газа', 1);
INSERT INTO ORDERS(ORDER_ID, AMOUNT, DESCRIPTION, CLIENT_ID) VALUES (2, 2000000, 'пару нано штуковин', 2);
INSERT INTO ORDERS (ORDER_ID, AMOUNT, DESCRIPTION, CLIENT_ID) VALUES (3, 3000000, 'пару галонов нефти', 3);

INSERT INTO ORDERS_CONTACTS_BINDING(ORDER_ID, CONTACT_ID) VALUES (1, 1);
INSERT INTO ORDERS_CONTACTS_BINDING(ORDER_ID, CONTACT_ID) VALUES (2, 2);
INSERT INTO ORDERS_CONTACTS_BINDING(ORDER_ID, CONTACT_ID) VALUES (3, 3);